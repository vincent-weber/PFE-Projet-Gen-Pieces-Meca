...
void ScrewGenerator::generate(QString screw_part) {
    if (screw_part == "ScrewBodyCyl") {
        ...
        createLeafRulesSingle("cyl", screw_part, QVector3D(body_width, body_height, body_precision), QVector3D(0,0,0), QVector3D(PI/2,PI/2,0));
    }
        ...
        createLeafRulesSingle("cyl", screw_part, QVector3D(head_width, head_height, head_precision), QVector3D(0,body_height/2,0), QVector3D(PI/2,PI/2,0));
    }
        ...
        createLeafRulesSingle("cub", screw_part, QVector3D(head_width, head_height, head_width), QVector3D(0,body_height/2,0), QVector3D(0,0,0));
    }
        ...
        createLeafRulesSingle("cyl", screw_part, QVector3D(inter_cyl_radius, inter_cyl_length, inter_cyl_precision), QVector3D(0,body_height/2 - head_height/2,0), QVector3D(PI/2,PI/2,0));
    }
}
