...
void ScrewGenerator::generate(QString screw_part) {
    if (screw_part == "ScrewBodyCyl") {
        ...
        createLeafRules("cyl", screw_part, QVector3D(body_width, body_height, body_precision), QVector3D(0,0,0), QVector3D(PI/2,PI/2,0));
    }
        ...
        createLeafRules("cyl", screw_part, QVector3D(head_width, head_height, head_precision), QVector3D(0,body_height/2,0), QVector3D(PI/2,PI/2,0));
    }
        ...
        createLeafRules("cub", screw_part, QVector3D(head_width, head_height, head_width), QVector3D(0,body_height/2,0), QVector3D(0,0,0));
    }
