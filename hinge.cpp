...
void Hinge::generateRules(QString hinge_part) {
    ...
    if (hinge_part == "HingeMiddleCyl") {
        ...
        QVector3D center_cub_1(center[0] + (- middle_cyl_width - wing_length/2 + 0.003f) * dir_wings[0], center[1] + (- middle_cyl_width - wing_length/2 + 0.003f) * dir_wings[1], center[2] + (- middle_cyl_width - wing_length/2 + 0.003f) * dir_wings[2]);
        QVector3D center_cub_2(center[0] + (middle_cyl_width + wing_length/2 - 0.003f) * dir_wings[0], center[1] + (middle_cyl_width + wing_length/2 - 0.003f) * dir_wings[1], center[2] + (middle_cyl_width + wing_length/2 - 0.003f) * dir_wings[2]);
